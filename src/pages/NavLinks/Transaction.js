  ...
  return <div className="flex flex-col gap-8 p-8">
    ...
    <div className={toggle === 1 ? "show-content" : "content"}>
      ...
      <div className={toggle === 2 ? "show-content" : "content"}>
        ...
        <div className={toggle === 2 ? "show-content" : "content"}>
          <table className="w-full h-fit rounded font-tbc text-black">
            ...
            <tr className="flex justify-between w-full h-fit border-b font-tbc font-medium text-title24 text-center">
              ...
              <td className="  w-full p-3 text-black ">November 13, 2023</td>
              <td onClick={()=>updateToggle(6)} className="  w-full p-3 text-secondary300 underline font-bold cursor-pointer">View</td>
            </tr>
       ...
       <div className={toggle === 3 ? "show-content" : "content"}>
          ...
          <div className="flex items-center w-full h-fit">
            <h1 className=" font-heading font-bold text-heading14 text-secondary500">New Transaction:</h1>
          </div>
                ...
                <div className="flex flex-col gap-5"> 
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Client ID:</h1>
                    </div>
                    <input type="type" placeholder="Client Name na dropdown " className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>
                  
                  {/** per line inputs */}
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Client Name:</h1>
                    </div>
                    <input type="text" placeholder="tapos auto client id" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>

                  {/** per line inputs */}
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Payment Description:</h1>
                    </div>
                    <input type="text" placeholder="Input Payment Description" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>

                  {/** per line inputs */}
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Amount Paid:</h1>
                    </div>
                    <input type="text" placeholder="Input Amount" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>

                  {/** per line inputs */}
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Date of Payment:</h1>
                    </div>
                    <input type="date" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>

                  {/** per line inputs */}
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Mode of Payment:</h1>
                    </div>
                  ...
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Proof of Payment:</h1>
                    </div>
        ...
        <div className={toggle === 5 ? "show-content" : "content"}>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex items-center w-full h-fit">
              <h1 className=" font-heading font-bold text-heading14 text-secondary500">Invoice Form</h1>
            </div>
          ...
          <div className="flex flex-col gap-5 w-full h-fit">
              ...
              <form className="flex flex-col gap-10 w-full h-fit">
                ...
                <div className="flex flex-col gap-5"> 
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Invoice ID:</h1>
                    </div>
                    <input type="type" placeholder="Autocreate sana" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>
                  ...
                  <div className="flex gap-11 w-fit ">
                    <div className="flex items-center w-[300px]">
                      <h1 className=" font-tbc font-bold text-title13 text-black">Select Event</h1>
                    </div>
                    <select className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black">
                ...
                <table className="w-full h-fit rounded font-tbc text-black">
                    ...
                    <tr className="flex justify-between items-center w-full h-fit border-b font-tbc font-medium text-title24 text-center">
                      ...
                      <td className="  w-full p-3 text-black ">Input Description</td>
                      <td className="  w-full p-3 text-black ">xx,000</td>
                      <td className="  w-full p-3 text-secondary300 underline font-bold ">
                        <button className=" text-center bg-gray bg-opacity-40 rounded-3xl text-white">Delete</button>
                      </td>
                    </tr>
      ...
      <div className={toggle === 6 ? "show-content" : "content"}>
        ...
        <div className={toggle === 6 ? "show-content" : "content"}>
          <div className="flex items-center w-full h-fit">
            <h1 className=" font-heading font-bold text-heading14 text-secondary500">invoice #####</h1>
          </div>

          <div className="flex items-center w-full h-fit">
            <h1 className="font-heading font-bold text-title13 text-black">Package Type</h1>
          </div>

          {/** Center Breakdown */}
          <div className="flex flex-col gap-5">
            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">Reservation Fee</h1>
              <h1 className="font-tbc text-title24 text-black">5,000</h1>
            </div>

            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">150 Pax</h1>
              <h1 className="font-tbc text-title24 text-black">67,000</h1>
            </div>

            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">Photobooth</h1>
              <h1 className="font-tbc text-title24 text-black">3,500</h1>
            </div>

            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">Lights and Sounds</h1>
              <h1 className="font-tbc text-title24 text-black">5,000</h1>
            </div>

            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">Host Mafician</h1>
              <h1 className="font-tbc text-title24 text-black">5,500</h1>
            </div>

            {/** Total computation */}
            <div className="flex justify-between items-center border-b border-opacity-30 w-full h-fit">
              <h1 className="font-tbc font-bold text-title24 text-black">Total</h1>
              <h1 className="font-tbc font-bold text-title24 text-black">PHP 86,000</h1>
            </div>
          </div>
        ...
        <div className={toggle === 7 ? "show-content" : "content"}>
          ...
          <div className="flex flex-col gap-10">
            <div className="flex items-center w-full h-fit">
              <h1 className=" font-heading font-bold text-heading14 text-secondary500">Edit Invoice Form</h1>
            </div>
              ...
              <form className="flex flex-col gap-10 w-full h-fit">
                ...
                <div className="flex flex-col gap-5"> 
                  <div className="flex gap-11 w-fit ">
                    ...
                    <input type="type" placeholder="Auto call kung ano ung eedit" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>
                  ...
                  <div className="flex gap-11 w-fit ">
                    ...
                    <input type="text" placeholder="Auto call kung ano ung eedit" className="w-[350px] border border-gray border-opacity-30 rounded px-5 py-3 font-tbc font-bold text-title13 text-black"/>
                  </div>
