...
const AddSetModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="modalset-container relative border border-gray-300 rounded-lg bg-white h-fit w-1/4"
      ...
      >
        ...
        <div className="flex flex-col gap-5 p-5">
          <div className="flex flex-col gap-2 font-tbc font-medium text-title13">
            <label for="dish-set">Dish 1 (Pork or Chicken):</label>
            <input
              type="text"
              /*onChange={(e) => {
          ...
          <div className="flex flex-col gap-2 font-tbc font-medium text-title13">
            <label for="dish-set">Dish 2 (Fish):</label>
            <textarea
              /*onChange={(e) => {
          ...
          <div className="flex flex-col gap-2 font-tbc font-medium text-title13">
            <label for="dish-set">Dish 3 (Pasta):</label>
            <input
              type="text"
              /*onChange={(e) => {
          ...
          <div className="flex flex-col gap-2 font-tbc font-medium text-title13">
            <label for="dish-set">Dish 4 (Dessert):</label>
            <input
              type="text"
              /*onChange={(e) => {
                setContact(e.target.value);
